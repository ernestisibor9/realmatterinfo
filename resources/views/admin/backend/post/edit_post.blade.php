        ...
        <div class="col-lg-10 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form  action="{{ route('update.post') }}" method="post" class="forms-sample"
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <select name="blogcat_id" class="form-control mb-3" aria-label="Default select example">
                            ...
                            <option value="{{ $cat->id }}" {{ $cat->id == $post->cat_id ? 'selected' : '' }} >{{ $cat->category_name }}</option>
                            @endforeach
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" name="post_title" class="form-control" value="{{ $post->post_title }}" id="input1">
                    </div>
                </div>
                <div class="form-group col-12">
                    <label for="input1" class="form-label">YouTube URL</label>
                    <input type="text" name="video_url" class="form-control" value="{{ $post->video_url }}" id="input1">
                </div>
                <div class="form-group col-md-12">
                    <label for="input1" class="form-label">Post Description</label>
                    <textarea name="long_descp" class="form-control" id="mytextarea">{!! $post->long_descp !!}</textarea>
                </div>
